...
<?php
/* *******************************************************************************************
 * parser.php - Imagine having a personal assistant who could read a letter for you, understand
 * the placeholders in it, and fill them in with the exact details you provide. That’s exactly
 * what the TemplateParser class does!
 * 
 * This class is like a master key to your templates. It opens the door to any template file,
 * reads it, and understands the placeholders in it. But it doesn’t stop there. It goes one step
 * further and replaces those placeholders with the values you provide.
 * 
